...
// page directory index 虚拟地址la的页目录项的索引 页目录项:以la的高10位为索引值
#define PDX(la) ((((uintptr_t)(la)) >> PDXSHIFT) & 0x3FF)   //PDXSHIFT: 22    

// page table index         页表项:以线性地址la的中10位为索引值
#define PTX(la) ((((uintptr_t)(la)) >> PTXSHIFT) & 0x3FF)   //PTXSHIFT: 12   

// page number field of address 地址页码字段
...
// address in page table or page directory entry  高20位为page结构的物理地址
